    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.templates.email.store') }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="is_global" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_global') ? 'checked' : '' }}>
                    ...
                    <x-template-preview-modal :route="route('admin.templates.email.preview')" type="email" />
                </div>
            </div>
        </div>
    </div>
